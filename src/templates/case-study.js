...
export default ({ data }) => (
  <div className="case-study">
    ...
    <Hero className="has-bg-image is-medium is-success blog-hero" style={{ backgroundImage: "url(" + (data.caseStudy.heroBannerImage ? data.caseStudy.heroBannerImage.fluid.src : '' )+ "&blend=http%3A%2F%2Fassets.imgix.net%2Fblog%2Fblog-blends.pdf%3Fpage%3D1%26fm%3Dpng&blend-mode=multiply&blend-w=2500&blend-h=1000&blend-fit=crop&blend-align=left,center&blend-crop=left,center)" }} id="blog-hero">
